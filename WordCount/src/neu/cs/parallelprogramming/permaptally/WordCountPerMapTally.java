package neu.cs.parallelprogramming.permaptally;
...
public class WordCountPerMapTally {
    ...
    public static class Map extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        // Map function uses a hashmap to create output pairs. Hashmap is used to calculate count for each word
        // in this call. New Text word is created for each work put into a hashmap
        @Override
        public void map(final LongWritable key, final Text value, final Context context) throws IOException, InterruptedException {
            final String line = value.toString();
            final StringTokenizer tokenizer = new StringTokenizer(line);
            final java.util.Map<Text, Integer> wordCountMap = new HashMap<Text, Integer>();
            ...
            Iterator<Text> wordCountMapIterator = wordCountMap.keySet().iterator();
            while(wordCountMapIterator.hasNext()) {
                final Text wordKey = wordCountMapIterator.next();
                final IntWritable wordCount = new IntWritable(wordCountMap.get(wordKey));
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final Job job = new Job(conf, "wordcountpermaptally");
