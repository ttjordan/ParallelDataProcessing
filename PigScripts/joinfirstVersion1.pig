...
filtered_join_result = FILTER join_result by ((Flights1_filtered::Year == 2007 AND Flights1_filtered::Month >= 6) OR (Flights1_filtered::Year == 2008 AND Flights1_filtered::Month <= 5)) AND ((Flights2_filtered::Year == 2007 AND Flights2_filtered::Month >= 6) OR (Flights2_filtered::Year == 2008 AND Flights2_filtered::Month <= 5)) AND (Flights1_filtered::ArrTime < Flights2_filtered::DepTime);
